...
db_name = 'webapp/database/Contact_Tracing.db'
...
def get_data():
    try:
        ...
        sql_fetch_blob_query = """SELECT id, name, email, address, gender, phone,location_record  from Contact"""
...
def save_fingerprint(id_num):
    try:
        ...
        writeTofile(record[0][0], "fingerprint_data.bin")
